...
class FunnelApi
{
    ...
    {
        $loader_exists = class_exists('\HP_RW\Services\FunnelConfigLoader');
        error_log('[HP-Abilities] is_hp_rw_available: FunnelConfigLoader=' . ($loader_exists ? 'YES' : 'NO'));
        return $loader_exists;
    }
    ...
    {
        error_log('[HP-Abilities] hp_rw_not_available: HP-React-Widgets classes not loaded');
        return [
            'success' => false,
            'error'   => 'HP-React-Widgets plugin is not active or classes not loaded.',
        ];
    }
        ...
        try {
            ...
            if (class_exists('\HP_RW\Services\FunnelSeoAuditor')) {
                ...
                if (is_wp_error($audit)) {
                    return ['success' => false, 'error' => $audit->get_error_message()];
                }
                return [
                    'success' => true,
                    'data'    => self::ensureArrayRecursive($audit),
                ];
            }
